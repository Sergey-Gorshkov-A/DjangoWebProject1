...
urlpatterns = [
    ...
    path('orderpost/<int:parametr>/', views.orderpost, name='orderpost'),
    path('order/', views.order, name='order'),
    path('editorder/<int:parametr>/', views.editorder, name='editorder'),
    path('completedorder/<int:parametr>/', views.completedorder, name='completedorder'),
    ...
    path('addreview/<int:parametr>/', views.addreview, name='addreview'),
    path('editreview/<int:parametr>/', views.editreview, name='editreview'),
